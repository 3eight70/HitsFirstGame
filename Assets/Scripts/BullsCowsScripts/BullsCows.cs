...
namespace BullsCows
{
    public class BullsCows : MonoBehaviour
    {
        [SerializeField] private InputField UserNumber;
        ...
        {
            BullsCowsUI.Instance.ShowWinPopup(text);
        ...
        {
            BullsCowsUI.Instance.ShowErrorPopup(text);
        }
